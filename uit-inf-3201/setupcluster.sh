...
[[ -z $(mount -l | grep /mnt/users/anomo6531/3201-grading-assignment1/) ]] && sshfs anomo6531@ificluster.ifi.uit.no:/mnt/users/anomo6531/3201-grading-assignment1/ /tmp/studentcode
